...
CREATE TABLE Sach (
    ...
    maTheLoai  VARCHAR(50)  NOT NULL,
    maNXB      VARCHAR(50)  NOT NULL,
    trangThai  ENUM('CON_TRONG_KHO','HET_HANG','NGUNG_BAN') NOT NULL DEFAULT 'CON_TRONG_KHO',
...
CREATE TABLE PhieuNhap (
    ...
    trangThai   ENUM('CHO_XU_LY','DA_NHAP','HUY') NOT NULL DEFAULT 'CHO_XU_LY',
...
CREATE TABLE PhieuXuat (
    ...
    tongTien    DECIMAL(15,2) NOT NULL DEFAULT 0,
    trangThai   ENUM('CHO_XU_LY','DA_XUAT','HUY') NOT NULL DEFAULT 'CHO_XU_LY',
...
INSERT INTO TaiKhoan VALUES
    ...
    ('TK002', 'nhanvien1', 123456, 'NQ002', 'HOAT_DONG'),
    ('TK003', 'nhanvien2', 123456, 'NQ003', 'HOAT_DONG'),
    ('TK004', 'nhanvien3', 123456, 'NQ002', 'HOAT_DONG'),
    ('TK005', 'nhanvien4', 123456, 'NQ002', 'NGUNG');

-- NhanVien
INSERT INTO NhanVien VALUES
    ('NV001', 'Nguyễn', 'Văn An',    '0901234567', '123 Lê Lợi, Q1, TP.HCM',             'an.nguyen@sach.vn',    'TK001', 'HOAT_DONG'),
...
INSERT INTO Sach VALUES
    ('S001', 'Cho tôi xin một vé đi tuổi thơ',  2009, 85000.00,  50, 'TG001', 'TL001', 'NXB001', 'CON_TRONG_KHO'),
    ('S002', 'Mắt biếc',                         2016, 95000.00,  30, 'TG001', 'TL003', 'NXB001', 'CON_TRONG_KHO'),
    ('S003', 'Đắc nhân tâm',                     2018, 120000.00, 80, 'TG005', 'TL002', 'NXB003', 'CON_TRONG_KHO'),
    ('S004', 'Dế Mèn phiêu lưu ký',              2020, 65000.00,  20, 'TG003', 'TL001', 'NXB002', 'CON_TRONG_KHO'),
    ('S005', 'Harry Potter và Hòn đá phù thủy',  2015, 150000.00, 15, 'TG004', 'TL004', 'NXB002', 'CON_TRONG_KHO'),
    ('S006', 'Nhà giả kim',                       2019, 110000.00, 40, 'TG006', 'TL003', 'NXB003', 'CON_TRONG_KHO'),
    ('S007', 'Sapiens: Lược sử loài người',       2020, 185000.00, 25, 'TG007', 'TL005', 'NXB005', 'CON_TRONG_KHO'),
    ('S008', 'Tôi tài giỏi, bạn cũng thế',       2017, 130000.00, 60, 'TG002', 'TL002', 'NXB003', 'CON_TRONG_KHO'),
    ('S009', 'Truyện Kiều',                       2021,  75000.00, 35, 'TG008', 'TL008', 'NXB004', 'CON_TRONG_KHO'),
    ('S010', 'Doraemon - Tập 1',                  2022,  35000.00,  0, 'TG002', 'TL001', 'NXB002', 'HET_HANG'),
    ('S011', 'Nghĩ giàu làm giàu',                2016, 145000.00, 10, 'TG005', 'TL007', 'NXB005', 'CON_TRONG_KHO'),
    ('S012', 'Conan - Tập 1',                     2023,  38000.00,  0, 'TG002', 'TL001', 'NXB002', 'NGUNG_BAN');
...
INSERT INTO PhieuNhap VALUES
    ...
    ('PN006', '2026-03-06', 'NV003', 'NCC002',  2800000.00, 'CHO_XU_LY');
...
INSERT INTO PhieuXuat VALUES
    ...
    ('PX008', '2026-03-07', 'NV002', 'KH003', NULL,    150000.00, 'CHO_XU_LY'),
