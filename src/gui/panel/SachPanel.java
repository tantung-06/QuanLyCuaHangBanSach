...
public class SachPanel extends JPanel {
    ...
    // ── Padding ngoài (giống initPadding của SanPham) ────
    ...
    private JPanel buildFunctionBar() {
        ...
        // --- Phải: tìm kiếm + lọc, căn giữa dọc bằng GridBagLayout ---
        ...
        cboFilter = new JComboBox<>(new String[]{"Tất cả", "DANG_BAN", "NGUNG_BAN"});
    ...
    private JPanel buildTablePanel() {
        ...
        // Renderer: căn giữa + màu trạng thái + zebra
        table.setDefaultRenderer(Object.class, new DefaultTableCellRenderer() {
            public Component getTableCellRendererComponent(JTable t, Object v,
                ...
                if (col == 8 && v != null) {
                    setForeground("DANG_BAN".equals(v.toString())
