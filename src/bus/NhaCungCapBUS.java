...
public class NhaCungCapBUS {
    ...
    public boolean insert(NhaCungCap ncc) {
        ...
        if (ncc.getMaNCC() == null || ncc.getMaNCC().trim().isEmpty()) return false;
        if (ncc.getTenNCC() == null || ncc.getTenNCC().trim().isEmpty()) return false;
        if (ncc.getSoDienThoai() == null || ncc.getSoDienThoai().trim().isEmpty()) return false;
    ...
    public boolean updateTrangThai(String maNCC, String trangThai) {
        if (maNCC == null || maNCC.trim().isEmpty()) return false;
